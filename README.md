...
🔗 **Or directly visit the demo via this [🔗 link](https://public.tableau.com/views/PizzaSalesDashBoardHarshWadiyaLatest/HOME?:language=en-US&:sid=&:redirect=auth&showOnboarding=true&:display_count=n&:origin=viz_share_link)**.
